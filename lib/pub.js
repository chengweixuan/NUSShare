...
if(Meteor.isServer){
  ...
  Meteor.publish('Questions', function(){//'Jokes' has to correspond to the elements in collections aka mongodb
    if(!this.userId){// if "this" user is not logged in dont publish the jokeForm
      return false;
      throw new Meteor.Error("not authorised");
    }else{
  ...
  Meteor.publish('Pinned', function(){//'Jokes' has to correspond to the elements in collections aka mongodb
    if(!this.userId){// if "this" user is not logged in dont publish the jokeForm
      return false;
      throw new Meteor.Error("not authorised");
    }else{
  ...
  Meteor.publish('ProfileComments', function(){//'Jokes' has to correspond to the elements in collections aka mongodb
    if(!this.userId){// if "this" user is not logged in dont publish the jokeForm
      return false;
      throw new Meteor.Error("not authorised");
    }else{
